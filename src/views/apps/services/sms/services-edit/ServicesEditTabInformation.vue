      ...
      <b-row>
        ...
        <b-col cols="12" md="6" lg="4">
          <b-form-group label="Full Name" label-for="Full Name">
            <b-form-input
              id="fullname"
              v-model="ServiceDataInfo.C_Name"
              :state="ServiceDataInfo.C_Name.length > 0"
        ...
        <b-col cols="12" md="6" lg="4">
          <b-form-group label="Email" label-for="Email">
            <b-form-input
              id="email"
              v-model="ServiceDataInfo.C_Email"
              :state="ServiceDataInfo.C_Email.length > 0"
              placeholder="Email"
            />
            <b-form-valid-feedback> Looks good! </b-form-valid-feedback>
            <b-form-invalid-feedback>
        ...
        <b-col cols="12" md="6" lg="4">
          <b-form-group label="Adress" label-for="Adress">
            <b-form-input
              id="adress"
              v-model="ServiceDataInfo.C_Adress"
              :state="ServiceDataInfo.C_Adress.length > 0"
              placeholder="Adress"
            />
            <b-form-valid-feedback> Looks good! </b-form-valid-feedback>
            <b-form-invalid-feedback>
        ...
        <b-col cols="12" md="6" lg="4">
          <b-form-group label="Birth Date" label-for="birth-date">
            <b-form-datepicker
              id="datepicker-valid"
              v-model="ServiceDataInfo.C_DoB"
              :state="ServiceDataInfo.C_DoB.length > 0"
            />
            <b-form-valid-feedback> Looks good! </b-form-valid-feedback>
            <b-form-invalid-feedback>
              Please provide a valid input.
        ...
        <b-col cols="12" md="6" lg="4">
          <b-form-group label="Telephone Number" label-for="Telephone Number">
            <b-form-input
              id="telephone"
              v-model="ServiceDataInfo.C_Phone"
              :state="ServiceDataInfo.C_Phone.length > 0"
        ...
        <b-col cols="12" md="6" lg="4">
          <b-form-group label="Gender" label-for="gender" label-class="mb-1">
            <b-form-radio-group
              id="gender"
              v-model="ServiceDataInfo.gender"
...
export default {
  ...
  setup({ serviceinfo }) {
    const ServiceDataInfo = ref({ ...serviceinfo, gender: "male" });
