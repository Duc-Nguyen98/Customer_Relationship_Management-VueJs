          ...
          <validation-observer ref="information_user">
            <b-form class="mt-1">
              ...
              <div class="d-flex mb-2">
                ...
                <h4 class="mb-0 ml-50">Information</h4>
              </div>
              <b-row>
                <!-- Field: Name  -->
...
import {
  BRow, BCol, BCard, BCardText, BCardBody, BForm, BFormGroup, BFormInput, BButton, BTable, BCardTitle, BFormCheckbox, BCardHeader,
} from 'bootstrap-vue'
import {
  required,
  email,
...
export default {
  components: {
    BRow, BCol, BCard, BCardText, BCardBody, BForm , BFormGroup, BFormInput, vSelect, BButton, BTable, BCardTitle, BFormCheckbox, BCardHeader,
    ValidationProvider,
    ValidationObserver,
  },
  setup() {
